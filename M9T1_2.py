...
Примечания:
    ...
    При попытке передачи, например, списка из строк,
        некоторые функции могут работать некорректно или вовсе не работать.
...
def apply_all_func(int_list, *functions):
    """
    Вызвает каждую функцию к переданному списку int_list
